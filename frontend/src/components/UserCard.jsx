  ...
  return (
    <>
      <div
        ...
        className="group relative p-4 border border-gray-300 rounded-3xl shadow-md bg-black text-white hover:border-blue-600 transition duration-300 hover:bg-[#141414]  cursor-pointer"
      >
        <div
      ...
      {isDialogOpen && (
        <UserDetails employee={employee} onClose={handleCloseDialog} />
      )}
    </>
  );
};
